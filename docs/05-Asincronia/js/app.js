...
async function cargarSecuencial() {
    ...
    try {
        // 5.1.1: Usar await para cargar 'Usuario' (500-1000ms)
        ...
        tiempoSecuencial = total; // Guarda el tiempo para la comparativa
